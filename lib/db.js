...
export async function readDB()  { return TOKEN ? await ghGet() : await localGet(); }
export async function writeDB(data, message) { return TOKEN ? await ghPut(data, message) : await localPut(data); }
